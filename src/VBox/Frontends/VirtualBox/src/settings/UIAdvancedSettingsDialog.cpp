...
void UIAdvancedSettingsDialog::sltRetranslateUI()
{
    ...
    if (m_pMd3DialogEmojis)
    {
        ...
        const QString strDescription = UIMd3Language::instance()
                                     ...
                                     : tr("Decorate dialog and message-box messages with a relevant emoji; "
                                          "buttons, action labels, field labels and accessible names are unchanged");
        m_pMd3DialogEmojis->setText(strText);
        m_pMd3DialogEmojis->setAccessibleName(strText);
        m_pMd3DialogEmojis->setAccessibleDescription(strDescription);
        m_pMd3DialogEmojis->setToolTip(strDescription);
    }
...
void UIAdvancedSettingsDialog::sltUpdateMd3AppearanceControls()
{
    ...
    if (m_pMd3DialogEmojis)
    {
        ...
        m_pMd3DialogEmojis->setChecked(UIMd3EmojiSetting::isEnabled());
    }
    if (m_pMd3Brand)
    {
...
void UIAdvancedSettingsDialog::prepareSelector()
{
    ...
    if (pLanguagePanel)
    {
        ...
        m_pMd3DialogEmojis = new QCheckBox(pLanguagePanel);
        m_pMd3DialogEmojis->setChecked(UIMd3EmojiSetting::isEnabled());
        ...
        {
            UIMd3EmojiSetting::setEnabled(fEnabled);
        });
